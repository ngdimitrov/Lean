...
class GlobalQuant(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.lookback_regime  = 252            # ~1yr of returns for HMM fitting
        ...
        s, q, t, g = self.symbols
        self.regime_weights = {
            "bull": {s: 0.40, q: 0.40, t: 0.10, g: 0.10},   # risk-on
            "flat": {s: 0.20, q: 0.15, t: 0.30, g: 0.20},   # balanced / defensive
            "bear": {s: 0.00, q: 0.00, t: 0.45, g: 0.35},   # flight-to-safety
        }
    ...
    def OnData(self, data: Slice):
        ...
        if self.Time.DayOfWeek != DayOfWeek.Monday:
            return
